def editlaunchfile(Panes):
    ...
    os_command = 'mv -T '
    full_command = os_command + Full_path_launch_file + space + Full_path_launch_file_new_format
    ...
    Panes[1].send_keys(full_command, enter=True)
    ...
    full_command = os_command + Full_path_launch_file_new_format + space + Full_path_launch_file
    #os.system("gnome-terminal -- /bin/sh -c 'mv /home/avl/Desktop/LaunchFiles/Camera1_with_IMU.launch /home/avl/Desktop/LaunchFiles/Camera1_with_IMU.txt' ") --> Full command example
    Panes[1].send_keys(full_command, enter=True)

    return [Full_path_launch_file, Full_path_launch_file_new_format, Full_Given_name,Given_name,full_command]